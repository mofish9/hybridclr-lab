...
| Unchanged paths retain AOT routing | no-op and complete assembly-mode checks in the resource workflow | Passed for tested methods |
...
| Windows startup/prepare/load/assets cost is measured | C# concurrent timing sample, 100/100 | Exploratory gate: P50 16.574s, P95 17.026s, P99 18.769s |
